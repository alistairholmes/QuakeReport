...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error in making the request to USGS", e);
        }

        List<Earthquake> earthquakes = extractEarthquakes(jsonResponse);
        Log.d(LOG_TAG, "TEST: Request has been made to fetch data.");
        return earthquakes;
    }
    ...
    private static URL createUrl(String stringURL) {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Error, could not create url", e);
        }
        return url;
    }
    ...
    public static List<Earthquake> extractEarthquakes(String earthquakeJSON) {
        ...
        // Try to parse the USGS_REQUEST_URL Response. If there's a problem with the way the JSON
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                JSONObject propertiesObject = f.getJSONObject("properties");
                ...
                // Extract the URL of the earthquake
