...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        // display the 2 Strings in 2 separate TextViews.
        // Find the TextView in the list_item.xml layout with the ID offset_location_text_view.
        TextView offsetTextView = (TextView) listItemView.findViewById(R.id.offset_location_text_view);
        // Get the Place from the currentEarthquake object and set this text on
        // the Offset TextView.
        offsetTextView.setText(offsetLocation);

        // Find the TextView in the list_item.xml layout with the ID offset_location_text_view.
        TextView primaryTextView = (TextView) listItemView.findViewById(R.id.primary_location_text_view);
        // Get the Place from the currentEarthquake object and set this text on
        // the Offset TextView.
